...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            {{--<a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Please Select the--}}
            {{--Type of Exposure</a>--}}
            {{--</h4>--}}
            {{--</div>--}}
            ...
            {{--Definition of True Exposure:--}}
            {{--<ul type="Disc">--}}
            {{--<li>Eye, mouth, other mucous membrane, non-related skin or--}}
            {{--parenteral contact with blood,--}}
            {{--other body fluids or other potentially infectious material.--}}
            {{--</li>--}}
            {{--<li>--}}
            {{--Inhalation of potentially contagious microbes.--}}
            {{--</li>--}}
            {{--<li>--}}
            {{--Contact with an infected patient’s skin lesions or body--}}
            {{--fluids that can cause--}}
            {{--infectious disease that require preventative treatment or--}}
            {{--quarantine.--}}
            {{--</li>--}}
            {{--</ul>--}}
            {{--Parenteral Exposure :--}}
            {{--<ul type="Disc">--}}
            {{--<li>Occurs through a break in the skin barrier, this includes--}}
            {{--injections, needle sticks,--}}
            {{--human/ animal bites, abrasions and cuts that become--}}
            {{--contaminated with blood.--}}
            {{--</li>--}}
            {{--<li>--}}
            {{--For human/animal bites, the clinical evaluation must include--}}
            {{--the possibility that both--}}
            {{--the person bitten and the person/animal that inflicted the--}}
            {{--bite were exposed to--}}
            {{--bloodborne pathogens.--}}
            {{--</li>--}}
            {{--</ul>--}}
            {{--</div>--}}
            ...
            {{--<br>--}}
            {{--Contamination might be due to soiling or pollution, as by the--}}
            {{--introduction of blood or--}}
            {{--body fluids onto:--}}
            {{--<ul type="Disc">--}}
            {{--<li>Equipment--}}
            {{--</li>--}}
            ...
            {{--<div class="panel-heading">--}}
            {{--<h4 class="panel-title">--}}
            {{--<a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Click Here for True--}}
            {{--Exposure</a>--}}
            {{--</h4>--}}
            {{--</div>--}}
            ...
            {{--<div class="col-sm-12 form-group well well-sm">--}}
            {{--<div class="col-sm-4">--}}
            {{--<a class="btn btn-success dropdown-toggle col-sm-12"--}}
            {{--type="button"--}}
            {{--href="{{ asset('Fillable PDFs\Exposure Complete\(Exposure PDF) OFD 184 State Infectious Disease Exposure Report.pdf')}}"--}}
            {{--download="(Exposure PDF) OFD 184 State Infectious Disease Exposure Report.pdf">--}}
            ...
            {{--</span>--}}
            {{--</label>--}}
            {{--<input type="text" id="upload-file-info"--}}
            ...
            {{--<div class="panel-heading">--}}
            {{--<h4 class="panel-title">--}}
            {{--<a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Click Here for--}}
            {{--Contamination</a>--}}
            {{--</h4>--}}
            {{--</div>--}}
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="btn-bottom">
                        {!! Form::submit('Save and Exit',['class' => 'btn btn-primary','name' => 'partialSave']) !!}
