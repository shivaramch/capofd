            ...
            <div class="panel panel-primary">
                ...
                <div id="collapse1" class="panel-collapse collapse">
                    ...
                    <span class="btn btn-info">
                        <i class="fa fa-cloud-upload" aria-hidden="true"></i> Upload<input type="file" name="trueOFD184" style="display: none;" multiple>
                    </span>
                                        </label>
                            ...
                            <div class="col-sm-12 form-group well well-sm">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        <label class="input-group-btn">
                    <span class="btn btn-info">
                        <i class="fa fa-cloud-upload" aria-hidden="true"></i> Upload<input type="file" name="postOFD184" style="display: none;" multiple>
                    </span>
                                        </label>
                                        <input type="text" id="upload-file-info" class="form-control" readonly>
                                    </div>
