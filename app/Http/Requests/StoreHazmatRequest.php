...
class StoreHazmatRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'dateofexposure' => 'required|date:hazmat,dateofexposure|before_or_equal:today'. $this->route('hazmat'),
            ...
            'frmsincidentnum1' => 'required|integer:hazmat,frmsincidentnum'. $this->route('hazmat'),
